...
// "this" is object joe values for the 3 parameters it holds
// 2. What is "this" when joe.scopeArrow() is invoked?
// The upper level up from the scope of the method which is the browser in this case
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions don't have their own scope and so they take the this of the next level up from them.
